...
| **E** | `INTEGRADA`, mapa ainda `em_andamento` | depois do ff, antes do mapa | **não integre de novo.** Promova as premissas pendentes que ainda faltarem, atualize o mapa (`entregue` + `Integrada em <sha>`) e commite |
